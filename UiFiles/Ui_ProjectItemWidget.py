...
class Ui_ProjectItemWidget(object):
    def setupUi(self, ProjectItemWidget):
        ...
        ProjectItemWidget.resize(240, 212)
        ProjectItemWidget.setMinimumSize(QtCore.QSize(240, 212))
        ProjectItemWidget.setMaximumSize(QtCore.QSize(240, 212))
        ...
        self.horizontalLayout_3.setContentsMargins(0, 10, 10, 0)
